      ...
      <div class="panel-body no-padding">
        <table class="table table-striped">
          ...
          <tbody>
            ...
            include "koneksi.php";
            $i=1;
            $sql=mysql_query("SELECT * FROM pengajuan WHERE jenis ='B1' AND status !='Belum Di Ajukan' AND pengaju !='SRI DEWI MARPAUNG'");
          ...
          <div class="panel-body no-padding">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                include "koneksi.php";
                $i=1;
                $sql=mysql_query("SELECT * FROM pengajuan WHERE jenis ='B2' AND status !='Belum Di Ajukan' AND pengaju !='SRI DEWI MARPAUNG'");
                while ($d=mysql_fetch_array($sql)) {
                  ...
                  <div class="panel-body no-padding">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        include "koneksi.php";
                        $i=1;
                        $sql=mysql_query("SELECT * FROM pengajuan WHERE jenis ='Non Rutin' AND status !='Belum Di Ajukan' AND pengaju !='SRI DEWI MARPAUNG'");
                        while ($d=mysql_fetch_array($sql)) {
                      ...
                      <div class="panel-body no-padding">
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            include "koneksi.php";
                            $i=1;
                            $sql=mysql_query("SELECT * FROM pengajuan WHERE jenis ='Honor KM' AND status !='Belum Di Ajukan'");
                            while ($d=mysql_fetch_array($sql)) {
