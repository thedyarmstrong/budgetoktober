            ...
            if(mysql_num_rows($liatbayar) == 0) {
             ...
             else
             {
               ...
               if ($persetujuan == 'Belum Disetujui' && $statusbayar == 'Belum Di Bayar'){
                 ...
                 else if ($persetujuan == 'Disetujui (Direksi)' && $statusbayar == 'Belum Di Bayar'){
                   $color = '#fff5c6';
                 }
                 else if ($persetujuan == 'Pending' && $statusbayar == 'Belum Di Bayar'){
                   $color = 'orange';
                 }
                 else if ($persetujuan == 'Disetujui (Direksi)' && $statusbayar == 'Telah Di Bayar' && ($exin == 'Honor Eksternal' || $exin == 'Vendor/Supplier' || $exin == 'Lumpsum')){
                   $color = '#d5f9bd';
                 }
                 else if ($persetujuan == 'Disetujui (Direksi)' && $statusbayar == 'Telah Di Bayar' && ($exin == 'Pulsa' || $exin == 'Biaya External')){
                   $color = '#d5f9bd';
                 }
                 else if ($persetujuan == 'Disetujui (Direksi)' && $statusbayar == 'Telah Di Bayar' && $exin == 'UM'){
                   $color = '#8aad70';
                 }
                 else if ($persetujuan == 'Disetujui (Direksi)' && $statusbayar == 'Realisasi (Direksi)' && $exin == 'UM'){
                   $color = '#eef2dc';
                 }
                 else if ($persetujuan == 'Disetujui (Direksi)' && $statusbayar == 'Realisasi (Finance)' && $exin == 'UM'){
                   $color = '#d5f9bd';
                 }
               ...
               echo "</b><br/>";
                   ...
                   else if ($persetujuan == 'Disetujui (Direksi)' && ($statusbayar == 'Telah Di Bayar' || $statusbayar == 'Realisasi (Finance)' || $statusbayar == 'Realisasi (Direksi)')){
                     echo "<i class='far fa-check-square'></i> Pengajuan";
                     echo "</b><br/>";
                     echo "<i class='far fa-check-square'></i> Approval";
                     echo "</b><br/>";
